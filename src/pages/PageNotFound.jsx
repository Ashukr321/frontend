...
const PageNotFound = () => {
  ...
  {/* Hello world */}
  <div  className="wrapper py-32 md:py-0"  >
    ...
    <div className=' mb-10  flex w-full items-center gap-4 justify-center '>
    <Link to={'/'}>

    <Button  variant="contained" sx={{padding:"16px 32px"}}>go to Home</Button>

    </Link>
    <img className='error_img' src="https://img.freepik.com/free-photo/fun-3d-cartoon-teenage-boy_183364-81177.jpg?w=740&t=st=1695845065~exp=1695845665~hmac=dc35484f49dc5fb43f00706b7ac73de91b4111ec139484b781d8d8ed7a0c8d27" alt="" />
